...
struct ProcessedEvent 
{
  ...
  double cathode = -1;
  double xavg = -1e6, x1 = -1e6, x2 = -1e6, xavg_tilt = -1e6;
  double theta = -1e6;
  ...
  double sabreRingMultiplicity[5] = {0,0,0,0,0}, sabreWedgeMultiplicity[5] = {0,0,0,0,0};
  
  double delayFrontRightE = -1, delayFrontLeftE = -1, delayFrontAvgE = -1;
  double delayBackRightE = -1, delayBackLeftE = -1, delayBackAvgE = -1;
